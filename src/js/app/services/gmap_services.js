(function(){
    ...
    function gmapServices($log, $q) {
        ...
        service.defaultLatLng = new google.maps.LatLng(14.655315675861079, 121.06239424347072);
        ...
        var geojsonInfoWindow = service.createInfoWindow('');
        ...
        function loadGeoJson(json, opts) {
            ...
            */
            ...
            var defaultCallback = function (event) {
                var content = "";
                ...
                geojsonInfoWindow.setOptions({pixelOffset: pixelOffset});
                geojsonInfoWindow.setPosition(event.latLng);
                geojsonInfoWindow.open(service.map);
            };

            var callback = opts.callback ? opts.callback : defaultCallback;
            service.map.data.addListener('click', callback);
